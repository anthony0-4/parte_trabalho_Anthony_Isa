...
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `habilidades` varchar(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `livraria` (
  ...
  `estabelicimento` varchar(150) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE IF NOT EXISTS `livro` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `titulo` varchar(150) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
-- Copiando estrutura para tabela trabalhoavaliativo02.login
CREATE TABLE IF NOT EXISTS `login` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `Senha` int unsigned NOT NULL DEFAULT '0',
  `user` varchar(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `cfm_senha` int unsigned NOT NULL DEFAULT '0',
